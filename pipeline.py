...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.e3d27b4d-c7c2-49c4-8023-965a413b2ada"),
    everyone_conditions_of_interest=Input(rid="ri.foundry.main.dataset.812c5a3e-eb3b-4dc5-873e-b7ccf29dbbd2"),
    everyone_devices_of_interest=Input(rid="ri.foundry.main.dataset.311b1bc4-c6e6-4d7d-b594-a868ca4f9810"),
    everyone_drugs_of_interest=Input(rid="ri.foundry.main.dataset.82d2b7c2-f021-4433-a2bc-3f761d6b7452"),
    everyone_measurements_of_interest=Input(rid="ri.foundry.main.dataset.3adf6d16-197d-42ea-8d1d-cf0d5b8e5e55"),
    everyone_observations_of_interest=Input(rid="ri.foundry.main.dataset.5c07bd1e-7eb6-415a-a542-ab19d4fd0491"),
    everyone_patient_deaths=Input(rid="ri.foundry.main.dataset.309bd88e-af02-4206-b035-dc4205264208"),
    everyone_procedures_of_interest=Input(rid="ri.foundry.main.dataset.3cc69172-4493-432c-bd4f-ade982b767e5"),
    everyone_vaccines_of_interest=Input(rid="ri.foundry.main.dataset.0436787c-40eb-43f5-b7c5-a4386eec89c7"),
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.34e71ee7-e139-4434-a0b2-97c2584a644e"),
    Sdoh_variables_all_patients=Input(rid="ri.foundry.main.dataset.0ba44b7c-2167-4845-a647-97decc41e41c"),
    all_patients_fact_day_table_LDS=Input(rid="ri.foundry.main.dataset.e3d27b4d-c7c2-49c4-8023-965a413b2ada"),
    everyone_cohort_1=Input(rid="ri.foundry.main.dataset.45b28176-dfb5-4fdd-885e-eeb2c03e262a"),
    everyone_patient_deaths=Input(rid="ri.foundry.main.dataset.309bd88e-af02-4206-b035-dc4205264208")
)
...
def all_patients_summary_fact_table_LDS(all_patients_fact_day_table_LDS, everyone_cohort_1, everyone_patient_deaths, Sdoh_variables_all_patients):
    ...
    df = everyone_cohort_1.join(df, 'person_id','left')
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.756c1612-9d06-43b2-8628-39a7a2296e80"),
    LL_DO_NOT_DELETE_REQUIRED_concept_sets_all=Input(rid="ri.foundry.main.dataset.284f8923-c023-405c-ac1b-239e99b6d9a2"),
    LL_concept_sets_fusion_everyone=Input(rid="ri.foundry.main.dataset.a6a7765f-9860-4341-9142-c3cbcc58853f")
)
# customized_concept_set_input (98658ea7-2622-4d42-9112-9796c11638ea): v3
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.45b28176-dfb5-4fdd-885e-eeb2c03e262a"),
    concept_set_members=Input(rid="ri.foundry.main.dataset.e670c5ad-42ca-46a2-ae55-e917e3e161b6"),
    location=Input(rid="ri.foundry.main.dataset.efac41e8-cc64-49bf-9007-d7e22a088318"),
    manifest=Input(rid="ri.foundry.main.dataset.b1e99f7f-5dcd-4503-985a-bbb28edc8f6f"),
    microvisit_to_macrovisit_lds=Input(rid="ri.foundry.main.dataset.5af2c604-51e0-4afa-b1ae-1e5fa2f4b905"),
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.812c5a3e-eb3b-4dc5-873e-b7ccf29dbbd2"),
    concept_set_members=Input(rid="ri.foundry.main.dataset.e670c5ad-42ca-46a2-ae55-e917e3e161b6"),
    condition_occurrence=Input(rid="ri.foundry.main.dataset.900fa2ad-87ea-4285-be30-c6b5bab60e86"),
    customized_concept_set_input_1=Input(rid="ri.foundry.main.dataset.756c1612-9d06-43b2-8628-39a7a2296e80"),
    everyone_cohort_1=Input(rid="ri.foundry.main.dataset.45b28176-dfb5-4fdd-885e-eeb2c03e262a")
)
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.311b1bc4-c6e6-4d7d-b594-a868ca4f9810"),
    concept_set_members=Input(rid="ri.foundry.main.dataset.e670c5ad-42ca-46a2-ae55-e917e3e161b6"),
    customized_concept_set_input_1=Input(rid="ri.foundry.main.dataset.756c1612-9d06-43b2-8628-39a7a2296e80"),
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.82d2b7c2-f021-4433-a2bc-3f761d6b7452"),
    concept_set_members=Input(rid="ri.foundry.main.dataset.e670c5ad-42ca-46a2-ae55-e917e3e161b6"),
    customized_concept_set_input_1=Input(rid="ri.foundry.main.dataset.756c1612-9d06-43b2-8628-39a7a2296e80"),
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.3adf6d16-197d-42ea-8d1d-cf0d5b8e5e55"),
    concept_set_members=Input(rid="ri.foundry.main.dataset.e670c5ad-42ca-46a2-ae55-e917e3e161b6"),
    everyone_cohort_1=Input(rid="ri.foundry.main.dataset.45b28176-dfb5-4fdd-885e-eeb2c03e262a"),
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.5c07bd1e-7eb6-415a-a542-ab19d4fd0491"),
    concept_set_members=Input(rid="ri.foundry.main.dataset.e670c5ad-42ca-46a2-ae55-e917e3e161b6"),
    customized_concept_set_input_1=Input(rid="ri.foundry.main.dataset.756c1612-9d06-43b2-8628-39a7a2296e80"),
    everyone_cohort_1=Input(rid="ri.foundry.main.dataset.45b28176-dfb5-4fdd-885e-eeb2c03e262a"),
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.309bd88e-af02-4206-b035-dc4205264208"),
    concept_set_members=Input(rid="ri.foundry.main.dataset.e670c5ad-42ca-46a2-ae55-e917e3e161b6"),
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.3cc69172-4493-432c-bd4f-ade982b767e5"),
    concept_set_members=Input(rid="ri.foundry.main.dataset.e670c5ad-42ca-46a2-ae55-e917e3e161b6"),
    customized_concept_set_input_1=Input(rid="ri.foundry.main.dataset.756c1612-9d06-43b2-8628-39a7a2296e80"),
    everyone_cohort_1=Input(rid="ri.foundry.main.dataset.45b28176-dfb5-4fdd-885e-eeb2c03e262a"),
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.0436787c-40eb-43f5-b7c5-a4386eec89c7"),
