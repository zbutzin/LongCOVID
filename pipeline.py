...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.317360b5-5247-43a9-b9bd-a637768d57f0"),
    everyone_conditions_of_interest=Input(rid="ri.foundry.main.dataset.ec6b28cf-580a-418a-87da-9de2389ad16d"),
    everyone_devices_of_interest=Input(rid="ri.foundry.main.dataset.c6819d45-0a43-4516-a8ca-f4228b5c94a2"),
    everyone_drugs_of_interest=Input(rid="ri.foundry.main.dataset.b5931bdb-2c91-4990-a1c3-951d1130e074"),
    everyone_measurements_of_interest=Input(rid="ri.foundry.main.dataset.d759adb6-a162-4371-ab8a-61933ff189c7"),
    everyone_observations_of_interest=Input(rid="ri.foundry.main.dataset.e19c93db-632e-40d6-80c1-afd5eb6112b5"),
    everyone_patient_deaths=Input(rid="ri.foundry.main.dataset.dd5a29c2-04e2-42dd-8c8d-8c78561280fa"),
    everyone_procedures_of_interest=Input(rid="ri.foundry.main.dataset.60cf5550-a3c4-4b6d-99e5-9e11b814bd06"),
    everyone_vaccines_of_interest=Input(rid="ri.foundry.main.dataset.0749644f-0249-4e14-bbb9-2db559a86aaf"),
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.d63d9b6a-7ac7-4e2d-bb9d-c0ad0584c214"),
    Sdoh_variables_all_patients=Input(rid="ri.foundry.main.dataset.0ba44b7c-2167-4845-a647-97decc41e41c"),
    all_patients_fact_day_table_LDS=Input(rid="ri.foundry.main.dataset.317360b5-5247-43a9-b9bd-a637768d57f0"),
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.6ebaa007-ef73-4f62-91a7-ca3190be5ffb"),
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.f819c71b-662f-4498-8963-714bd5415544"),
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.ec6b28cf-580a-418a-87da-9de2389ad16d"),
    concept_set_members=Input(rid="ri.foundry.main.dataset.e670c5ad-42ca-46a2-ae55-e917e3e161b6"),
    condition_occurrence=Input(rid="ri.foundry.main.dataset.900fa2ad-87ea-4285-be30-c6b5bab60e86"),
    customized_concept_set_input=Input(rid="ri.foundry.main.dataset.6ebaa007-ef73-4f62-91a7-ca3190be5ffb"),
    everyone_cohort=Input(rid="ri.foundry.main.dataset.f819c71b-662f-4498-8963-714bd5415544")
)
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.c6819d45-0a43-4516-a8ca-f4228b5c94a2"),
    concept_set_members=Input(rid="ri.foundry.main.dataset.e670c5ad-42ca-46a2-ae55-e917e3e161b6"),
    customized_concept_set_input=Input(rid="ri.foundry.main.dataset.6ebaa007-ef73-4f62-91a7-ca3190be5ffb"),
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.b5931bdb-2c91-4990-a1c3-951d1130e074"),
    concept_set_members=Input(rid="ri.foundry.main.dataset.e670c5ad-42ca-46a2-ae55-e917e3e161b6"),
    customized_concept_set_input=Input(rid="ri.foundry.main.dataset.6ebaa007-ef73-4f62-91a7-ca3190be5ffb"),
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.d759adb6-a162-4371-ab8a-61933ff189c7"),
    concept_set_members=Input(rid="ri.foundry.main.dataset.e670c5ad-42ca-46a2-ae55-e917e3e161b6"),
    everyone_cohort=Input(rid="ri.foundry.main.dataset.f819c71b-662f-4498-8963-714bd5415544"),
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.e19c93db-632e-40d6-80c1-afd5eb6112b5"),
    concept_set_members=Input(rid="ri.foundry.main.dataset.e670c5ad-42ca-46a2-ae55-e917e3e161b6"),
    customized_concept_set_input=Input(rid="ri.foundry.main.dataset.6ebaa007-ef73-4f62-91a7-ca3190be5ffb"),
    everyone_cohort=Input(rid="ri.foundry.main.dataset.f819c71b-662f-4498-8963-714bd5415544"),
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.dd5a29c2-04e2-42dd-8c8d-8c78561280fa"),
    concept_set_members=Input(rid="ri.foundry.main.dataset.e670c5ad-42ca-46a2-ae55-e917e3e161b6"),
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.60cf5550-a3c4-4b6d-99e5-9e11b814bd06"),
    concept_set_members=Input(rid="ri.foundry.main.dataset.e670c5ad-42ca-46a2-ae55-e917e3e161b6"),
    customized_concept_set_input=Input(rid="ri.foundry.main.dataset.6ebaa007-ef73-4f62-91a7-ca3190be5ffb"),
    everyone_cohort=Input(rid="ri.foundry.main.dataset.f819c71b-662f-4498-8963-714bd5415544"),
