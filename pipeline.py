...
def custom_concept_sets():
    schema = StructType([StructField("concept_set_name", StringType(), True), StructField("codeset_id", StringType(), True), StructField("indicator_prefix", StringType(), True), StructField("domain", StringType(), True)])
    return spark.createDataFrame([["End Stage Renal Disease ","null","ENDSTAGERENALDISEASE","condition_occurrence"],[None,None,None,None],["RHEUMATOLOGIC DISEASE","null","RHEUMATOLOGICDISEASE","condition_occurrence, observation"],["SICKLE CELL DISEASE","null","SICKLECELLDISEASE","condition_occurrence"],["SUBSTANCE ABUSE","null","SUBSTANCEABUSE","condition_occurrence, observation"],["SUBSTANCE USE DISORDER","null","SUBSTANCEUSEDISORDER","condition_occurrence, observation"],["THALASSEMIA","null","THALASSEMIA","condition_occurrence"],["TOBACCO SMOKER","null","TOBACCOSMOKER","condition_occurrence, observation, measurement"],["TRANSPLANT OF SOLID ORGAN OR BLOOD STEM CELL","null","SOLIDORGANORBLOODSTEMCELLTRANSPLANT","procedure_occurrence, condition_occurrence, observation, measurement"],["TUBERCULOSIS","null","TUBERCULOSIS","condition_occurrence, observation"],["B94.8 Sequelae of other specified infectious and parasitic diseases","null","B94_8","condition_occurrence"],["Remdesivir","null","REMDISIVIR","drug_exposure"],["DOWN SYNDROME","null","DOWNSYNDROME","condition_occurrence"],["HEART FAILURE","null","HEARTFAILURE","condition_occurrence"],["HEMIPLEGIA or PARAPLEGIA","null","HEMIPLEGIAORPARAPLEGIA","condition_occurrence"],["HIV INFECTION","null","HIVINFECTION","condition_occurrence"],["HYPERTENSION","null","HYPERTENSION","condition_occurrence"],["AUTOIMMUNE DISEASE/IMMUNODEFICIENCY","null","OTHERIMMUNOCOMPROMISED","condition_occurrence"],["KIDNEY DISEASE","null","KIDNEYDISEASE","condition_occurrence, observation, measurement"],["MALIGNANT CANCER","null","MALIGNANTCANCER","condition_occurrence, observation"],["METASTATIC SOLID TUMOR CANCERS","null","METASTATICSOLIDTUMORCANCERS","condition_occurrence, observation"],["MILD LIVER DISEASE","null","MILDLIVERDISEASE","condition_occurrence, observation, measurement"],["MODERATE OR SEVERE LIVER DISEASE","null","MODERATESEVERELIVERDISEASE","condition_occurrence, observation"],["MYOCARDIAL INFARCTION","null","MYOCARDIALINFARCTION","condition_occurrence"],["N3C CORTICOSTEROIDS FOR SYSTEMIC USE","null","SYSTEMICCORTICOSTEROIDS","drug_exposure"],["OBESITY","null","OBESITY","condition_occurrence, observation, measurement"],["PEPTIC ULCER","null","PEPTICULCER","condition_occurrence"],["PERIPHERAL VASCULAR DISEASE","null","PERIPHERALVASCULARDISEASE","condition_occurrence"],["PREGNANT","null","PREGNANCY","condition_occurrence, observation"],["PSYCHOSIS","null","PSYCHOSIS","condition_occurrence"],["PULMONARY EMBOLISM","null","PULMONARYEMBOLISM","condition_occurrence"],["CARDIOMYOPATHIES","null","CARDIOMYOPATHIES","condition_occurrence"],["CEREBROVASCULAR DISEASE","null","CEREBROVASCULARDISEASE","condition_occurrence"],["CHRONIC LUNG DISEASE","null","CHRONICLUNGDISEASE","condition_occurrence, observation, measurement"],["CONGESTIVE HEART FAILURE","null","CONGESTIVEHEARTFAILURE","condition_occurrence"],["CORONARY ARTERY DISEASE","null","CORONARYARTERYDISEASE","condition_occurrence"],["DEMENTIA","null","DEMENTIA","condition_occurrence"],["DEPRESSION","null","DEPRESSION","condition_occurrence"],["DIABETES COMPLICATED","null","DIABETESCOMPLICATED","condition_occurrence"],["DIABETES UNCOMPLICATED","null","DIABETESUNCOMPLICATED","condition_occurrence"]], schema=schema)
